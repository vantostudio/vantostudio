    ...
    <article data-work className="flex h-full flex-col text-paper">
      ...
      <div className="flex flex-1 flex-col border-b border-paper/12 pt-6 pb-7">
        ...
        <div className="mt-auto flex flex-wrap items-center gap-5 pt-6 text-sm font-semibold">
          <Link href={`/work/${project.slug}`} data-cursor="Read" className="text-accent">
            Read the case study →
          </Link>
          <a href={project.href} target="_blank" rel="noreferrer" data-cursor="Visit" className="border-b border-paper/28 pb-1 text-paper/72">
            {project.linkLabel} ↗
          </a>
        </div>
      </div>
