...
export const buildSteps = [
  ["STEP 01", "btb-wireframe", "Structure", "The audience, page order, and purpose of each section are resolved before visual design."],
  ["STEP 02", "btb-design", "Design", "Typography, colour, imagery, and interaction turn that structure into a distinctive visual system."],
  ["STEP 03", "btb-code", "Build", "The approved direction becomes a responsive, accessible, and carefully tested website."],
  ["STEP 04", "btb-launch", "Launch", "The site goes live on your domain with final checks, handover, and a clear plan for support."],
] as const;
